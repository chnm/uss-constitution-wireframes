...
<div class="row">
    <div class="large-12 columns">
        <h2 data-intro="The general browse portal for Collection and Ship's Company. The header here will change to reflect which portal a user is in.">Explore: Type of Material</h2>
    </div>

    <div>
        <div data-intro="Filters that will allow users to drill down to the various subsets of these item types." class="large-3 columns">
            <button class="button large-12">View Filter</button>
        </div>
    ...
    <button class="button large-2 right">More Items</button>
</div>
